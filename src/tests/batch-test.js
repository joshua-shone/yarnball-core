...
test('batch test', function(t) {
  ...
  batch.getLinkCount().then(function(linkCount) {
    t.equal(linkCount, 1, 'Calling getLinkCount() on a new empty batch should return the number of links in the underlying web.');
  })
